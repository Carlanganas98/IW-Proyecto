...
public class EmpleadoController {
    ...
    public String solicitudesReparacionAceptar(Model model, @RequestParam long id_reparacion, HttpSession session, @RequestParam List<String> info, @RequestParam List<Double> precio)
    {
